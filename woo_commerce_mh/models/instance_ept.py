...
class WooInstanceEpt(models.Model):
    ...
    def _default_order_status(self):
        order_status = self.env.ref('woo_commerce_mh.processing')
    ...
    def _default_shipping_product(self):
        ...
        """
        shipping_product = self.env.ref('woo_commerce_mh.product_woo_shipping_ept', False)
    ...
    def _default_fee_product(self):
        ...
        """
        fee_product = self.env.ref('woo_commerce_mh.product_woo_fees_ept', False)
        if not fee_product:
            raise UserError(_("Please upgrade the module and then try to create new instance.\n Maybe the Fee "
                              "product has been deleted, it will be recreated at the time of module upgrade."))
        return fee_product
    ...
    def _default_discount_product(self):
        ...
        """
        discount_product = self.env.ref('woo_commerce_mh.product_woo_discount_ept', False)
    ...
    def get_total_orders(self):
        ...
        view = self.env.ref('woo_commerce_mh.action_woo_orders').sudo().read()[0]
    ...
    def get_total_products(self):
        ...
        view = self.env.ref('woo_commerce_mh.action_woo_product_template_exported_ept').sudo().read()[0]
    ...
    def get_customers(self):
        ...
        view = self.env.ref('woo_commerce_mh.action_woo_partner').sudo().read()[0]
    ...
    def get_refund(self):
        ...
        view = self.env.ref('woo_commerce_mh.action_refund_woo_invoices_ept').sudo().read()[0]
    ...
    def perform_operation(self, record_id):
        ...
        """
        view = self.env.ref('woo_commerce_mh.action_wizard_woo_instance_import_export_operations').sudo().read()[0]
    ...
    def open_report(self, record_id):
        ...
        """
        view = self.env.ref('woo_commerce_mh.woo_sale_report_action_dashboard').sudo().read()[0]
    ...
    def open_logs(self, record_id):
        ...
        """
        view = self.env.ref('woo_commerce_mh.action_common_log_book_instance_ept').sudo().read()[0]
    ...
    def action_open_deactive_wizard(self):
        ...
        """
        view = self.env.ref('woo_commerce_mh.view_inactive_woo_instance')
        return {
    ...
    def reset_woo_credentials(self):
        ...
        form_view_id = self.env.ref('woo_commerce_mh.view_set_woo_credential').id
        vals = {
